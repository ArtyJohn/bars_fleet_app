...
//  Использует рабочий прокси для России
// ================================================================
...
const CloudSync = {
    ...
    // ================================================================
    //  ⚠️ ВЫБЕРИТЕ ОДИН ИЗ ПРОКСИ (раскомментируйте нужный)
    // ================================================================
    // Вариант 1: allorigins (часто работает в РФ)
    PROXY_URL: 'https://api.allorigins.win/raw?url=',
    
    // Вариант 2: cors-anywhere (если первый не работает)
...
console.log('🔗 PROXY_URL:', CloudSync.PROXY_URL);
